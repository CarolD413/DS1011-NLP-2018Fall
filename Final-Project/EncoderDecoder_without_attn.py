...
class DecoderRNN(nn.Module):
    def __init__(self, embedding_size, hidden_size, output_size, n_layer=1, dropout=0.5,attention=False):
...
# Bahdanau
    ...
    def forward(self, input_seq, last_hidden, src_len = None , encoder_outputs=None):
        ...
        if self.attention:
            ...
            context_vector = torch.sum(encoder_outputs.transpose(0,1), dim=1).unsqueeze(1)
...
def train(dataset, batch_size, n_epochs, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, 
    ...
    writer=SummaryWriter('./tensorboard/ZHEN-withoutAttn')
    global_step = 0
    ...
    for i in range(n_epochs):
        ...
        for batch_idx, batch in enumerate(train_iter):
            ...
            if batch_idx % 100 == 0 and batch_idx != 0:
                print("batch: {}, loss: {}, accuracy: {}, edit distance: {}".format(batch_idx, loss, accuracy, edit_distance))
...
#         encoder_scheduler.step(30-bleu)
#         decoder_scheduler.step(30-bleu)
